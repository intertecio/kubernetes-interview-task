...
# EBS CSI Driver policy attachments
resource "aws_iam_role_policy_attachment" "ebscsidriver-AmazonEBSCSIDriverPolicy" {
  policy_arn = "arn:aws:iam::aws:policy/service-role/AmazonEBSCSIDriverPolicy"
  role       = aws_iam_role.eks_addon_ebs_csi_iam_role.name
}

# EKS LoadBalancer Controller policy attachments
resource "aws_iam_role_policy_attachment" "eksloadbalancercontroller-ElasticLoadBalancingFullAccess" {
